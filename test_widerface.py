...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset_folder', default='./dataset/val/images/ ', type=str, help='dataset path')
    ...
    with torch.no_grad():
        ...
        for p in tqdm(pict_folder):
            image_path = os.path.join(testset_folder, pict_folder[p], p)
